...
Die Informationen zum initialen Stand des Dokuments, aktiven Clients und die Subscription auf Änderungen werden anschliessend in einem einzelnen Flux zusammengefasst und zurückgegeben.
...
Ein DocumentCommand definiert unter anderem einen type, welcher ein Wert der Enum CommandType sein muss und eine Payload vom Typ String.
...
Im Fehlerfall wird dort eine ResponseEntity mit Statuscode 500 zurückgegeben.
...
Es liegt in der Verwantwortung des Clients die Verbindung erneut zu öffnen und den aktuellen Stand des Dokuments zu laden.
